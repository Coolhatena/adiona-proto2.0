        ...
        <div className="d-inline-block">
            ...
            <div className="grid mb-8 lg:mb-12 lg:grid-cols-2">
                <figure className="p-4 max-w-screen-md mx-auto">
                    ...
                    <blockquote className="pl-6 pr-6">
                        <p className="pl-6 pr-6 text-xl text-justif font-medium text-gray-900">&#34;Adiona Travel Agency made our honeymoon unforgettable. From airport transfers to surprise perks, their personalized service and meticulous planning were exceptional. Highly recommended!&#34;</p>
                    </blockquote>
                    <figcaption className="flex items-center justify-center mt-2 space-x-3">
                        <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
